...
{ 
	...
	memcpy((void*)(packet.SenderMACAddr.v), (void*)(AppConfig.MyMACAddr.v), 6);	// SHA
	packet.TargetMACAddr.v[0]=0xFF; 											// THA
    packet.TargetMACAddr.v[1]=0xFF; 
    packet.TargetMACAddr.v[2]=0xFF; 
    packet.TargetMACAddr.v[3]=0xFF; 
    packet.TargetMACAddr.v[4]=0xFF; 
	...
	packet.SenderIPAddr.Val  = AppConfig.MyIPAddr.Val;							// SPA
    packet.TargetIPAddr.Val  = AppConfig.MyIPAddr.Val; 							// TPA
