...
#define TCP_MAX_SEG_SIZE_TX			(536u)
...
// slow dial up modem).
#define TCP_MAX_SEG_SIZE_RX			(1460u)
...
#define TCP_SYN_QUEUE_MAX_ENTRIES	(5u) 					// Number of TCP RX SYN packets to save if they cannot be serviced immediately
