 ...
 */
#define MPFS_RESERVE_BLOCK              (128ul)
 ...
 */
#define MY_DEFAULT_HOST_NAME            "KO-5"
 ...
 */
    ...
    #define TCP_ETH_RAM_SIZE                    (2608ul)
    ...
    #define END_OF_TCP_SOCKET_TYPES
        ...
        } TCPSocketInitializer[] = 
        {
            ...
            //{TCP_PURPOSE_UART_2_TCP_BRIDGE, TCP_ETH_RAM, 256, 512},
...
// -- SNMP Options -------------------------------------------------------
    ...
    #define SNMP_COMMUNITY_MAX_LEN      (16u)
